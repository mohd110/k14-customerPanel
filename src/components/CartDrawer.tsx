      ...
      >
        ...
        {items.length === 0 ? (
          ...
          <>
              ...
              {items.map((item) => (
                <div key={item.product.id} className="flex items-center gap-3">
                  ...
                  <div className="flex items-center gap-1.5">
                    <button
                      className="w-7 h-7 rounded-full border border-neutral-700 flex items-center justify-center text-neutral-300 active:bg-neutral-800 transition-colors"
                    ...
                    <button
                      className="w-7 h-7 rounded-full flex items-center justify-center text-[#ff6b75] ml-1 active:bg-[#2a1416] transition-colors"
                      onClick={() => removeItem(item.product.id)}
                    >
                      <Trash2 className="size-3.5" />
                    </button>
                  </div>
                  <span className="text-sm font-bold w-12 text-right text-white">
            ...
            <div className="px-5 pt-3 pb-8 border-t bg-neutral-900 flex-shrink-0">
